...
function numero(xx) { //recoge el número pulsado en el argumento.
      ...
      let octal=xx.toString(8);
          pantalla2.innerHTML=octal;


         }
         function numer1(xx){
      let hexa=xx.toString(16);
          pantalla3.innerHTML=hexa;


        }     function numer2(xx){
           let binario=xx.toString(2);
               pantalla4.innerHTML=binario;
...
function borradoParcial() {
        ...
        pantalla2.innerHTML=0; //poner pantalla a 0
        pantalla3.innerHTML=0;
        pantalla4.innerHTML=0;
